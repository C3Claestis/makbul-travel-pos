...
import 'page/main/jamaah/jenispenerbangan_page.dart';
import 'page/main/jamaah/paketsaya_page.dart';
import 'page/main/jamaah/pembayaran_page.dart';

// 1. Ubah menjadi ConsumerWidget
class DashboardJamaahArsip extends ConsumerWidget {
  const DashboardJamaahArsip({super.key});
