...
class RegisterPageCopy extends ConsumerStatefulWidget {
  const RegisterPageCopy({super.key});

  @override
  ConsumerState<RegisterPageCopy> createState() => _RegisterPageStateCopy();
}

class _RegisterPageStateCopy extends ConsumerState<RegisterPageCopy> {
